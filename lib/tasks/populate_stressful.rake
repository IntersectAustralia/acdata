require File.join(File.dirname(__FILE__), 'sample_data_populator_stressful.rb')
require File.join(File.dirname(__FILE__), 'test_ldap.rb')

begin  
  namespace :db do  
    desc "Populate the database with some sample data for stressful testing"

    task :populate_stressful => :environment do
